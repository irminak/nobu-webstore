...
const Alert = ({ show, name }) => {
    return (
        ...
        >
            <div className='py-4 sm:py-8 lg:py-4 pl-4 pr-8 flex items-center justify-center'>
                <IoCheckmarkCircleOutline className='text-3xl sm:text-4xl lg:text-2xl text-primary' />
                <p className='pl-4 sm:text-2xl lg:text-lg'>
